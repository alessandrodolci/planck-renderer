...
export class CanvasContent {
  constructor(world, textContentArray) {
    this.world = world;
    this.textContentArray = textContentArray;
  }
}

export class CanvasRenderer {
  constructor(canvasContent, ctx, options = {}) {
  ...
  renderText() {
    const textContentArray = this.canvasContent.textContentArray;

    this.ctx.save();
    this.ctx.scale(this.options.scale, this.options.scale);
    textContentArray.forEach((textContent) => {
      this.ctx.fillText(...textContent);
    });
    this.ctx.restore();
  }
  ...
  renderWorld() {
    ...
    const world = this.canvasContent.world;
...
export default { TextContent, CanvasContent, CanvasRenderer };
